const site_config = {
    'notice': '', //公告内容，留空则不显示
    'code_store_link': 'https://galaxy-studio.ga', //卖激活码的发卡店链接
    'line1': '星际工作室客户邮箱系统',
    'line2': '包含 5TB Onedrive + Office 365',
    'code_api_link': ''
};

const ms_config = {
    'tenant_id': 'b89daa41-c2b0-4db4-97af-f4820df966a3',
    'client_id': 'b2037e6e-b37b-4d9e-82e8-e9877daec986',
    'client_secret': 'kN32l404-9D.vvP098SXNm-2-EU-~pwo9Y',
    'subscriptions': [{
        'name': '星际工作室客户邮箱',  //eg. Office 365 A1 for faculty
        'skuId': 'c42b9cae-ea4f-4ab7-9717-81576235ccac'
    }],
    'domains': ['galaxy-customer.ga']
};
